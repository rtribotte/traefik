...
schema_version: 2
kind: concept
name: RouterTCPTLSConfig
id: concept.routertcptlsconfig
source: oss
traefik_version: v3.7.0
extracted_from:
  - pkg/config/dynamic/tcp_config.go#L87
summary: RouterTCPTLSConfig holds the TLS configuration for a router.
fields:
  - name: passthrough
    go_name: Passthrough
    type: boolean
