...
extracted_from:
  - pkg/config/static/pkg/config/static/static_config.go#L86
summary: Configuration is the static configuration.
fields:
  - name: global
    go_name: Global
    type: object
    go_type: '*Global'
    type_ref: oss:static.Global
    fields:
  ...
  - name: serversTransport
    ...
    type_ref: oss:static.ServersTransport
  ...
  - name: tcpServersTransport
    ...
    type_ref: oss:static.TCPServersTransport
    fields:
      - name: dialKeepAlive
  ...
  - name: certificatesResolvers
    ...
    type_ref: oss:static.CertificateResolver
    fields:
      - name: acme
        go_name: ACME
        type: object
  ...
  - name: experimental
    ...
    type_ref: oss:static.Experimental
    fields:
      - name: plugins
        go_name: Plugins
        type: object
  ...
  - name: spiffe
    ...
    type_ref: oss:static.SpiffeClientConfig
    description: Spiffe defines the SPIFFE configuration.
    fields:
