...
make clean-webui generate-webui # Generate static contents in `webui/dist/` folder.
```
...
- Static contents are built in the `webui/dist/` directory

**Do not manually change the files in the `webui/dist/` directory**
