...
type Prometheus struct {
	...
	AddBackendsLabels    bool      `description:"Enable metrics on servers behind services." json:"addBackendsLabels,omitempty" toml:"addBackendsLabels,omitempty" yaml:"addBackendsLabels,omitempty" export:"true"`
