...
type Experimental struct {
	...
	KubernetesGateway bool                          `description:"Allow the k8s gateway api provider usage." json:"kubernetesGateway,omitempty" toml:"kubernetesGateway,omitempty" yaml:"kubernetesGateway,omitempty" export:"true"`
}
